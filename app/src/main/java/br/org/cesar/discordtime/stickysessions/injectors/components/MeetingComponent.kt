...
@Component(modules = [ContextModule::class, MeetingModule::class, MeetingPresenterModule::class, SessionModule::class, ServerModule::class, LoggerModule::class, NavigationModule::class, ThreadModule::class, NetworkModule::class, HttpLoggingInterceptorModule::class, HttpNetworkInterceptorModule::class, HttpModule::class, AuthModule::class])
